defmodule BootstrapFormDemoWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: BootstrapFormDemoWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/bootstrap_form_demo_web/templates",
        namespace: BootstrapFormDemoWeb
